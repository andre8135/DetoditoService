...
<%@page import="pe.edu.upc.entities.Proveedores"%>
        ...
        <div class="container-fluid" >
            <div class="row"> 
                ...
                <div class="col-sm-9 col-sm-offset- col-md-10 col-md-offset-1 main ">
                        ...
                        <table  <%--class="fixed-height fixed-width fixed-cell table-spacing" --%> align="center">
                            ...
                            <tr>
                                <td >
                                    <span class="input-group" >
                                        ...
                                        <input  type="search" name="buscar" placeholder='¿Que Busca?' style="background-color: #fff" >      
                                    </span>
                            ...
                            <tr>
                                <td >
                                    ...
                                    <select class=" select"  style="background-color:  #fff" name="slCategorias">
                    ...
                    <% IUsuariosRep repUser = new UsuariosRep();%>
                    <% Usuarios usuario = repUser.GetUsuarioById(servicio.getProveedores().getUsuarioId());%>
                    <%--<%= // servicio.getProveedores() %>--%>
                    <form action="ReservarServicio" method="get">
                        <br><br>
                        <table class="table table-striped table-hover table-bordered ">
                            <tbody
                                <tr>
                                    <td><%= servicio.getCategorias().getNombre()%></td>
                                    <td>Descripcion</td>                                    
                                    <td>Observaciones</td>
                                    <td>Proveedores</td>
                                    <td>Telefono</td>
                                ...
                                <tr class="info">
                                    ...
                                    <td><%= servicio.getObservaciones()%></td>
                                    <td><%= usuario.getNombre()%></td>
                                    <td> <%= usuario.getTelefono()%></td>
                                    <td><%= usuario.getCorreoElectronico()%></td>


                                    <td><%= servicio.getDepartamentos().getNombre()%></td>                                    
                                    <td><%= servicio.getProvincias().getNombre()%></td>
                                    <td><%= servicio.getDistritos().getNombre()%></td>
                                </tr>
                        ...
                        <center>
                            <input type="submit" class="btn btn-default btn-sm" value="Reservar">
                        </center>
