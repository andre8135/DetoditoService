                        ...
                        <div id="formLogin">
                            <div id="confirm" align="center">
                                ...
                                <form id="Formulario" method="Post" action="Login" onsubmit="return ValidateLogin()">
                                    ...
                                    <% }%>
                                    <div>
                                       <input type="submit" class="botn marginBottom" value="Acceder" onsubmit="return ValidateLogin()" >
                                       <a href="registro.jsp" >
                                        <input type="text"  class="botn marginBottom" value="Registrar" disabled id="alignCenter" >
                                       </a>  
                                    </div>
