            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <%if (session.getAttribute("Usuario") == null) {%>
                        <li>
                            <a href="registro.jsp" title="Registro" >Registros</a>
                        </li>
                        <% } else if (session.getAttribute("Usuario") != null) {%>                            
                        <% }%>        
                ...
                <div class="col-sm-9 col-sm-offset- col-md-10 col-md-offset-1 main ">
                    ...
                    <div id="confirm" >
                        ...
                        <form action="home.jsp">
                                ...
                                <h2>
                                    <p>Bienvenido, <%= session.getAttribute("Usuario").toString()%> </p>
                                    <p>Su usuario es: <%=session.getAttribute("Correo").toString()%></p>
                                </h2>
                            <br>
